    ...
    $('#procedure_form').submit(function() {
        $.ajax({
            ...
            success: function(data, textStatus, jqXHR) {
                ...
                html += '</div>';
                html += '<p class="disclaimer">Презентираните информации претставуваат приближен износ на трошоците.</p><p class="disclaimer">Поради постоење на голем број на варијабли, калкулаторот не пресметува со 100% точност.</p><p class="disclaimer">За да ја подобриме прецизноста или имате некои сугестии контактирајте не на skopjelh@gmail.com.</p>'
